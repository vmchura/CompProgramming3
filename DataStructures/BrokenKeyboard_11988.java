...
public class BrokenKeyboard_11988 {
    ...
    public void solve(){
        while(scanner.hasNext()){
            ...
            ListIterator<Character> current=linkedList.listIterator();
            boolean flagBeg=false;
            for(int i=0;i<T.length;i++){
                if(T[i]=='['){
                    flagBeg=true;
                    current=linkedList.listIterator();
                }else{
                    if(T[i]==']'){
                        flagBeg=false;
                    }else{
            ...
            for(Iterator<Character> iter=linkedList.iterator();iter.hasNext();){
                sb.append(iter.next());
            }
    ...
    public static void main(String[] args){
        BrokenKeyboard_11988 solver=new BrokenKeyboard_11988();
        solver.solve();       
    }
}
