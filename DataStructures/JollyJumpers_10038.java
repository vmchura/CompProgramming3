...
public class JollyJumpers_10038 {
    ...
    public void solve(){
         ...
         while(scanner.hasNext()){
             ...
             for(int i=0;i<n;i++){
                 ...
                 if(ant!=Integer.MAX_VALUE){
                     int diff=Math.abs(current-ant);
                     if(diff<=3000){
                         B[diff]=true;
                     }
    ...
    public static void main(String[] args){
        JollyJumpers_10038 solver=new JollyJumpers_10038();
        solver.solve();       
    }
}
