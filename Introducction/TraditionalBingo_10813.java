 ...
 * @author vchura
 */
public class TraditionalBingo_10813 {
    ...
    private TraditionalBingo_10813(){
            try{
...
Runtime.getRuntime().exec("gedit "+file_1.getAbsolutePath()+" "+file_2.getAbsolutePath());
    ...
    public void solve(){
        ...
        while(casos-->0){
                    ...
                    for(int i=0;i<5;i++){
                        for(int j=0;j<5;j++){
                            if(val==card[i][j]){
                                ...
                                if(i-j==0)
                                    resta0++;
                                if(sumCols[j]>=5 || sumRows[i]>=5 || suma4>=5 || resta0>=5){
                                    ans=b+1;
                                }
            ...
            PS.println(String.format("BINGO after %d numbers announced",ans));
        }
       closeFiles();
    ...
    public static void main(String[] args){
        TraditionalBingo_10813 solver=new TraditionalBingo_10813();
        solver.solve();       
    }
}
