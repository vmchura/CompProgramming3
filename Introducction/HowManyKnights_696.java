 ...
 * @author vchura
 */
public class HowManyKnights_696 {
...
Runtime.getRuntime().exec("gedit "+file_1.getAbsolutePath()+" "+file_2.getAbsolutePath());
    ...
    public void solve(){
        while(scanner.hasNext()){
            ...
            PS.println(String.format("%d knights may be placed on a %d row %d column board.",k,M,N));
        }
      closeFiles();
    ...
    public static void main(String[] args){
        HowManyKnights_696 solver=new HowManyKnights_696();
        solver.solve();       
    }
}
